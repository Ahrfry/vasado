...
IFLAG += -D__SIM_DDS__
IFLAG += -lpcap
LFLAG += -L "${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools/systemc/lib" -lsystemc -lpthread -lpcap
...
$(ObjDir)/udp.cpp_pre.cpp.tb.o : udp.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling udp.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
