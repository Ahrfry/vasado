...
#ifndef Block_codeRepl151Ee0_HH_
#define Block_codeRepl151Ee0_HH_

#include <systemc>
using namespace std;
SC_MODULE(Block_codeRepl151Ee0) {
    static const unsigned int DATA_WIDTH = 256;
    static const unsigned int ADDR_WIDTH = 5;
    static const unsigned int Block_codeRepl151Ee0_depth = 17;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[Block_codeRepl151Ee0_depth];
    ...
    SC_CTOR(Block_codeRepl151Ee0) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < Block_codeRepl151Ee0_depth; i++) {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (Block_codeRepl151Ee0_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < Block_codeRepl151Ee0_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (Block_codeRepl151Ee0_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > Block_codeRepl151Ee0_depth) {
...
#endif //Block_codeRepl151Ee0_HH_
