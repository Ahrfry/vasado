...
struct example : public sc_module {
    ...
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_ap_start;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_ap_done;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_ap_continue;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_ap_idle;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_ap_ready;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_prt_nw2sbu_TREADY;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_prt_cx2sbu_TREADY;
    sc_signal< sc_lv<256> > Block_codeRepl1510_p_U0_sbu2prt_nw_TDATA;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_sbu2prt_nw_TVALID;
    sc_signal< sc_lv<32> > Block_codeRepl1510_p_U0_sbu2prt_nw_TKEEP;
    sc_signal< sc_lv<1> > Block_codeRepl1510_p_U0_sbu2prt_nw_TLAST;
    sc_signal< sc_lv<3> > Block_codeRepl1510_p_U0_sbu2prt_nw_TID;
    sc_signal< sc_lv<12> > Block_codeRepl1510_p_U0_sbu2prt_nw_TUSER;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_mlx2sbu_TREADY;
    sc_signal< sc_lv<256> > Block_codeRepl1510_p_U0_sbu2mlx_TDATA;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_sbu2mlx_TVALID;
    sc_signal< sc_lv<32> > Block_codeRepl1510_p_U0_sbu2mlx_TKEEP;
    sc_signal< sc_lv<1> > Block_codeRepl1510_p_U0_sbu2mlx_TLAST;
    sc_signal< sc_lv<3> > Block_codeRepl1510_p_U0_sbu2mlx_TID;
    sc_signal< sc_lv<12> > Block_codeRepl1510_p_U0_sbu2mlx_TUSER;
    sc_signal< sc_lv<256> > Block_codeRepl1510_p_U0_sbu2prt_cx_TDATA;
    sc_signal< sc_logic > Block_codeRepl1510_p_U0_sbu2prt_cx_TVALID;
    sc_signal< sc_lv<32> > Block_codeRepl1510_p_U0_sbu2prt_cx_TKEEP;
    sc_signal< sc_lv<1> > Block_codeRepl1510_p_U0_sbu2prt_cx_TLAST;
    sc_signal< sc_lv<3> > Block_codeRepl1510_p_U0_sbu2prt_cx_TID;
    sc_signal< sc_lv<12> > Block_codeRepl1510_p_U0_sbu2prt_cx_TUSER;
    ...
    // Thread declarations
    void thread_Block_codeRepl1510_p_U0_ap_continue();
    void thread_Block_codeRepl1510_p_U0_ap_start();
    void thread_ap_done();
