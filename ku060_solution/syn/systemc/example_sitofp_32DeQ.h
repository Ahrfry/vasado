...
#ifndef __example_sitofp_32DeQ__HH__
#define __example_sitofp_32DeQ__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(example_sitofp_32DeQ) {
    ...
    SC_CTOR(example_sitofp_32DeQ):  ACMP_sitofp_U ("ACMP_sitofp_U") {
