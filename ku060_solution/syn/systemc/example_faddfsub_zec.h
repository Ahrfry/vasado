...
#ifndef __example_faddfsub_zec__HH__
#define __example_faddfsub_zec__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(example_faddfsub_zec) {
    ...
    SC_CTOR(example_faddfsub_zec):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
