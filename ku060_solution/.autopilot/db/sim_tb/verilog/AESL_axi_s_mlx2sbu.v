...
`define TV_IN_mlx2sbu_TDATA "./c.example.autotvin_mlx2sbu_V_data_V.dat"
`define INGRESS_STATUS_mlx2sbu_TDATA "./stream_ingress_status_mlx2sbu_V_data_V.dat"
`define TV_IN_mlx2sbu_TKEEP "./c.example.autotvin_mlx2sbu_V_keep_V.dat"
`define INGRESS_STATUS_mlx2sbu_TKEEP "./stream_ingress_status_mlx2sbu_V_keep_V.dat"
`define TV_IN_mlx2sbu_TLAST "./c.example.autotvin_mlx2sbu_V_last_V.dat"
`define INGRESS_STATUS_mlx2sbu_TLAST "./stream_ingress_status_mlx2sbu_V_last_V.dat"
`define TV_IN_mlx2sbu_TID "./c.example.autotvin_mlx2sbu_V_id_V.dat"
`define INGRESS_STATUS_mlx2sbu_TID "./stream_ingress_status_mlx2sbu_V_id_V.dat"
`define TV_IN_mlx2sbu_TUSER "./c.example.autotvin_mlx2sbu_V_user_V.dat"
`define INGRESS_STATUS_mlx2sbu_TUSER "./stream_ingress_status_mlx2sbu_V_user_V.dat"
