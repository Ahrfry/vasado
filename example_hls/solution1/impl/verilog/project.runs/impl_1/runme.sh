...
HD_PWD='C:/Users/chris/Downloads/user/tb/exp_hls/example/example_hls/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example.vdi -applog -m64 -messageDb vivado.pb -mode batch -source example.tcl -notrace
