...
HD_PWD='C:/Users/chris/Downloads/user/tb/exp_hls/example/example_hls/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example.vds -m64 -mode batch -messageDb vivado.pb -notrace -source example.tcl
