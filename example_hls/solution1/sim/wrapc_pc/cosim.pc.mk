...
LFLAG += -L "${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools/systemc/lib" -lsystemc -lpthread -L/C:/Users/chris/Downloads/pure_mlx/user/tb/exp_hls/example/WpdPack/Lib -lpacket -lwpcap
...
$(ObjDir)/hlsTb.cpp_pre.cpp.tb.o : hlsTb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling hlsTb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/stream_transfer.cpp_pre.cpp.tb.o : stream_transfer.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling stream_transfer.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
