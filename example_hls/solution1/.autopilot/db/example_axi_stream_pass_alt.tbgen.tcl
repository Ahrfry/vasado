set moduleName example_axi_stream_pass_alt
...
set isOneStateSeq 1
set C_modelName {example_axi_stream_pass_alt}
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : [], "CDFG" : "example_axi_stream_pass_alt", "VariableLatency" : "0", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
...
set Spec2ImplPortList { 
	...
	In_V_id_V { axis {  { In_r_TID in_data 0 3 } } }
	...
	Out_V_user_V { axis {  { Out_r_TVALID out_vld 1 1 }  { Out_r_TREADY out_acc 0 1 }  { Out_r_TUSER out_data 1 12 } } }
}
set moduleName example_axi_stream_pass_alt
set isCombinational 0
set isDatapathOnly 0
