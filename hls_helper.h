...
#pragma HLS inline
    ...
    std::cout<<"vec bot "<<bottom<<" "<<top<<std::endl;
...
#pragma HLS unroll
        ...
        std::cout<<"what about this "<<dst[i]<<std::endl;
    }
}
...
#pragma HLS inline
    write_byte<Width>(dest, offset, src >> 24);
    write_byte<Width>(dest, offset + 1, src >> 16);
    write_byte<Width>(dest, offset + 2, src >> 8);
    write_byte<Width>(dest, offset + 3, src);
}
